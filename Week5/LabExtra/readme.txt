...
- Upload the input file to HDFS: hdfs dfs -put my_code/NCDC-Weather_small.txt /user/input
- Run the Hadoop MapReduce job: hadoop jar my_code/StationTemp-1.0-SNAPSHOT.jar StationTempKey /user/input /user/output
